#ifndef INC_lis_lua_H
#define INC_lis_lua_H
...
int lisLoadScriptIntoState(struct lisLuaState *lua_state,char *directory,char *filename,int force); /* Returns: -1=error 0=already loaded 1=loaded */
